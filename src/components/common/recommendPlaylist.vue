<template>
    ...
    <div class="playlist-layout">
        <div v-for="item in playLists.sampleSize(10)" :key="item.id">
...
type IPlayList = RecommendPlayList[];
defineProps<{
    playLists: IPlayList
}>();
</script>
...
.playlist-layout {
    @apply grid grid-flow-row grid-cols-3 lg:grid-cols-5 gap-5 2xl:grid-cols-10
}
</style>
